      ...
      <div class="content">
        ...
        <div class="flex mt-4">
          <p>
            ...
            All money raised is fed back into the pupils
          </p>
        </div>
        <div class="flex mt-4">
          <p>
        ...
        <div class="flex w-1/2">
          <table class="table-fixed">
            <thead>
            <tr>
              <th class="w-64">&nbsp</th>
              <th class="w-64">&nbsp</th>
            </tr>
            </thead>
            <tbody>
            <div v-for="member in byDisplayOrder(members)">
              <tr>
                <td class="border px-4 py-2">{{ member.Role }}</td>
                <td class="border px-4 py-2">{{ member.Fullname }}</td>
              </tr>
            </div>
            </tbody>
          </table>
        ...
        <div class="flex mt-4">
          If you would like to pop in and share your ideas our next committee meeting is on {}, at Worpleston Place
        </div>
        <div class="flex mt-4">
          Our next 2nd Hand Uniform Sale is on {}
        </div>
...
export default {
  ...
  mounted() {
    ...
    let gcal = new PublicGcal({API_key: 'AIzaSyCOjUq0EVnczS5ifRNIS3kySfNi2TKiVvs', calendarId: 'friendsatchristscollege@gmail.com'});
    let termStart = '2020-09-01T09:00:00-07:00';
    let termEnd = '2021-07-31T09:00:00-07:00';
    gcal.getEvents({'timeMin': termStart, 'timeMax': termEnd}, function (error, result) {
      if (error) {
        console.log(error);
      }
      let i;
