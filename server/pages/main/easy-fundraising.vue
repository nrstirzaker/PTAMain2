  ...
  <div class="main flex-1">
    ...
    <div>
      <div class="flex w-full justify-center">
        <img class="object-fit:contain w-1/3" src="~/assets/images/general/easy-fundraising.png" alt="Easy Fundraising Logo">
      </div>
      <div>
        ...
        Christ’s College FCC easyfundraising information can be found XXXX
      </div>
    </div>
  </div>
</template>
