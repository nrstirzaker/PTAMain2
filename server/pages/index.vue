...
export default {
  ...
  methods: {
    next2ndHandUniformSaleDate: function () {
      const dates = [
        new Date("2021-10-22 15:15:00"),
        new Date("2021-11-24 15:15:00"),
        new Date("2022-01-28 15:15:00"),
        new Date("2022-02-23 15:15:00"),
        new Date("2022-04-29 15:15:00"),
        new Date("2022-05-25 15:15:00"),
        new Date("2022-06-24 15:15:00"),
        new Date("2022-07-13 15:15:00"),
        new Date("2022-08-13 10:00:00"),
        new Date("2022-08-27 10:00:00"),
